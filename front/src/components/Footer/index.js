                ...
                <div className = "container mx-auto px-4" >
                    <div className = "flex flex-wrap text-center lg:text-left" >
                        <div className = "w-full lg:w-6/12 px-4" >
                            <h4 className = "text-3xl font-semibold" >Visitez nos pages</h4>  
                    ...
                    <div className = "flex flex-wrap items-center md:justify-between justify-center" >
                        <div className = "w-full md:w-4/12 px-4 mx-auto text-center" >
                            <div className = "text-sm text-blueGray-500 font-semibold py-1" >Copyright© { new Date().getFullYear() } { " " } by { " " } 
                                < a href = "https://iteam-s.mg/" className = "text-blueGray-500 hover:text-blueGray-800" rel="noreferrer"  target="_blank"> SMARTONE </a> 
                            </div>  
                        </div>  
                    </div>  
                </div>  
